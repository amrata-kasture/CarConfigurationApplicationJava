...
class OptionSet implements Serializable {
  ...
  OptionSet(){
	...
	//get All Option Names given OptionSet Name as argument
		protected String[] getAllOptBySetName(String name) {
			String[] OptNames = new String[optAL.size()];
			for(int i=0;i<optAL.size();i++){
				OptNames[i] = optAL.get(i).getName()+"="+optAL.get(i).getPrice();
			}
			return OptNames;
		}
	...
	public String toString() {
		...
		sb.append(name).append(" Options and respective costs-> \t");
